                  ...
                  {/* Primera fila modal */}
                    <div class="flex flex-wrap -mx-3 mb-3">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" />
                            <p class="text-red-500 text-xs italic">Obligatorio</p>
                        </div>
